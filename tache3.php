...
<form class="cnt" action="tache3.php" method="post">
  ...
  <div class="form-group">
    ...
    <input name="prenom_etu" type="text" class="form-control" id="formGroupExampleInput" placeholder="Entrez le Prénom" value="<?php if(isset($_POST['btn_sele'])){ echo $myobject->Prenom ;}?>">
  </div>
